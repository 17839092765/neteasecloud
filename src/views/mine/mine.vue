  ...
  <div class="mine">
    ...
    <van-tabs v-model="activeName">
      <van-tab title="创建歌单" name="a">
        <ul
          class="musiclist"
          style="padding:20px 0 0 20px;color:#000;font-weight:900;font-size:16px"
        >
          <li style="margin:0 20px 0 0">歌单图片</li>
          <li style="margin:0 20px">歌单名</li>
          <li style="margin:0 20px">数量</li>
        </ul>
        <ul
        ...
        >
          ...
          <li style="height:50px;width:150px;text-align:center;">
            {{ item.name }}
          </li>
          <li style="height:50px">{{ item.trackCount }}首</li>
        </ul>
      </van-tab>
