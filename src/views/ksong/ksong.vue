...
<ul v-show="ulshow" class="ullist"> 
  <li class="lilist" v-for="(item, index) in arreylist" :key="index" @click="onclick(item)"><van-icon name="search" size="0.3rem" />{{item.keyword}}</li>
...
<div class="videos">
  ...
  <ul class="uuls">
    <li v-for="(item, index) in veideos" :key="index" @click="messgg(item)">
     ...
     <van-grid direction="horizontal" :column-num="3" icon-size="16" :border="false">
